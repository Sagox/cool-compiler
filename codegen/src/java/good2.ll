...
%class_Main = type { %class_Int*, %class_Int* }
...
entry:
	...
	%1 = load %class_Int*, %class_Int* %b.addr
	%2 = load %class_Int*, %class_Int* %a.addr
	%comp_2_0 = icmp eq i32 %2, 0
	br i1 %comp_2_0, label %func_div_by_zero_err, label %branch_2_0

proceed_2_0:
	i32 = udiv i32 %1, %2
	i32 = mul i32 %0, %3
	%5 = load %class_Int*, %class_Int* %b.addr
