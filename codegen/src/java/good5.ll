...
define %class_Bool @Main_check( %class_Main* %this, %class_Int* %n ) {
entry:
	%retval = alloca %class_Bool
	%this.addr = alloca %class_Main*
	%n.addr = alloca %class_Int*
	store %class_Int* %n, %class_Int* %n.addr
	store %class_Main* %this, %class_Main** %this.addr
	%this1 = load %class_Main*, %class_Main** %this.addr
	%a = getelementptr inbounds %class_Main, %class_Main* %this1, i32 0, i32 0
	%0 = load %class_Bool*, %class_Bool* %a.addr
	store %class_Bool %0, %class_Bool* %retval
	br label %fun_returning_basic_block
...
fun_returning_basic_block:
	%1 = load %class_Bool, %class_Bool* %retval
	ret %class_Bool %1
}
